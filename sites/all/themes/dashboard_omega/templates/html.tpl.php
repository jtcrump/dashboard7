...
<head>
  <?php print $head; ?>
  <title>Welcome to the Big Event!<?php // print $head_title; ?></title>
  <?php print $styles; ?>
  <?php print $scripts; ?>
...
<?php 
if(strtolower($_SERVER['HTTP_HOST']) == "mycampaignboard.com" and !isset($_SERVER['REDIRECT_URL'])) {
// print '<meta http-equiv="refresh" content="0;url=/login" />';
}


if(strtolower($_SERVER['HTTP_HOST']) != "mycampaignboard.com" and !isset($_SERVER['REDIRECT_URL']) and $user->roles[2] != 'authenticated user') {
?>

<div style="margin: auto; max-width: 450px;"><h2>Whoops!</h2>We need a little more information to get you where you need to be. <br /><br />
Please get your mailer, email or SMS message with your personalized URL and type it in the address box of your browser.<br /><br />Thank you!</div>
